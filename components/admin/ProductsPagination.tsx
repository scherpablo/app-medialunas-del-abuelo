      ...
      <nav className="flex justify-center py-10 gap-1 text-sm">
        {page > 1 && (
          <Link
            ...
            className="bg-white px-4 py-2 mr-3 hover:bg-amber-500 hover:font-black
        ...
        {pagesNumnber.map((pageNumber) => (
          <Link
            ...
            className={ `${page === pageNumber ? "bg-amber-500 font-black" : "bg-white" } px-4 py-2 
            text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-0` }
          >
            {pageNumber}
          </Link>
        ...
        {page < totalPages && (
          <Link
            href={`/admin/products-list?page=${page + 1}`}
            className="bg-white px-4 py-2 ml-3 hover:bg-amber-500 hover:font-black
           text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-0"
          >
            &raquo;
          </Link>
